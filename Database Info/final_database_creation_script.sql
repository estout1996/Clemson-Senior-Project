CREATE DATABASE final_application_db;
...
CREATE TRIGGER subtract_purchase_points
...
CREATE TRIGGER change_driver_points
...
DELIMITER //
CREATE TRIGGER add_base_company_views
...
DELIMITER $$
CREATE TRIGGER complete_base_company_views
